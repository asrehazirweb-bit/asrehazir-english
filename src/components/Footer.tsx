                    ...
                    <div className="space-y-4 font-sans mb-8">
                        ...
                        <div className="p-4 bg-white rounded-lg border border-gray-100 flex items-center justify-between">
                            ...
                            <div className="flex gap-2">
                                <a href="https://whatsapp.com/channel/asrehazir" target="_blank" rel="noreferrer" className="w-8 h-8 bg-green-500 text-white rounded-lg flex items-center justify-center hover:bg-green-600 transition-all">

            ...
            <header className={`sticky top-0 z-50 transition-all duration-300 ${isScrolled
                ...
                {!isScrolled && (
                    <div className="hidden md:block border-b border-gray-100 py-2">
                        <div className="w-full mx-auto px-6 flex justify-between items-center text-[10px] font-black uppercase tracking-[0.15em]">
                            ...
                            <div className="flex items-center gap-6">
                                <div className="flex gap-4 items-center text-gray-400">
                                    <a href={SOCIAL_LINKS.facebook} target="_blank" rel="noreferrer" className="hover:text-blue-600 transition-colors" title="Facebook">
                                        <Facebook size={14} />
                                    </a>
                                    <a href={SOCIAL_LINKS.x} target="_blank" rel="noreferrer" className="hover:text-black transition-colors" title="X (Twitter)">
                                        <X size={14} />
                                    </a>
                                    <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noreferrer" className="hover:text-pink-600 transition-colors" title="Instagram">
                                        <Instagram size={14} />
                                    </a>
                                    <a href={SOCIAL_LINKS.telegram} target="_blank" rel="noreferrer" className="hover:text-sky-500 transition-colors" title="Telegram">
                                    ...
                                    <a href={SOCIAL_LINKS.whatsapp} target="_blank" rel="noreferrer" className="hover:text-green-500 transition-colors" title="WhatsApp Channel">
                ...
                {!isScrolled && (
                    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 mb-4">
                        <AdBlock placement="header" className="!my-0" label="Premium Header Ad" />
                    </div>
                )}

            ...
            <div className="flex flex-col gap-8">
                ...
                <Link to={`/news/${featured.id}`} className="group cursor-pointer flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1 flex flex-col h-[260px] py-1">
                        <h3 className="text-xl md:text-2xl font-bold leading-tight text-secondary dark:text-gray-100 mb-3 group-hover:underline decoration-accent decoration-2 underline-offset-4 line-clamp-2">
                            {featured.title}
                        </h3>

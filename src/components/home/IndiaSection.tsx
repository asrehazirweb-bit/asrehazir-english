    ...
    return (
        <section className="flex flex-col w-full mb-12 font-serif border-b border-gray-100 pb-8 transition-colors">
            ...
            <div className="flex items-center justify-between mb-6 border-b border-gray-200 pb-2">
                ...
                <Link to="/national" className="flex items-center gap-1 text-sm font-bold text-accent hover:text-secondary transition-colors uppercase tracking-wide">
            ...
            <div className="flex flex-col gap-6">
                ...
                */}
                <Link to={`/news/${featured.id}`} className="group cursor-pointer flex flex-col sm:flex-row gap-6 items-start pb-6 border-b border-gray-100 block">
                    ...
                    <div className="flex flex-col h-full py-1">
                        <h3 className="text-xl font-bold leading-tight text-secondary mb-3 group-hover:underline decoration-accent decoration-2 underline-offset-4 line-clamp-2">
                            {featured.title}
                        </h3>
                ...
                <div className="flex flex-col">
                    {listItems.map((item) => (
                        <Link key={item.id} to={`/news/${item.id}`} className="group flex items-start py-3 border-b border-gray-100 last:border-0 hover:bg-gray-50 transition-colors px-2 -mx-2 cursor-pointer block">

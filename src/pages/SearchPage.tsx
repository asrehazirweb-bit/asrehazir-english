        ...
        <div className="pt-6 font-serif min-h-screen">
            <div className="w-full mx-auto px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 mb-12">
                ...
                <div className="lg:col-span-8 flex flex-col">
                    <div className="mb-8 border-b-2 border-red-700 pb-2 flex justify-between items-end">
                        <h1 className="text-3xl md:text-4xl font-black text-gray-900 dark:text-white uppercase tracking-tight">
                            Search Results
                        </h1>
                        <span className="text-sm font-sans font-bold text-red-700 hidden md:block italic">
                            Query: "{query}"
                        </span>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <div className="space-y-0">
                            <div className="mb-6">
                                <p className="text-sm text-gray-500 font-sans">
                                    Found <span className="text-red-700 font-bold">{mappedNews.length}</span> news items for your search.
                                </p>
                            </div>
                        ...
                        <div className="text-center py-20 bg-gray-50 dark:bg-zinc-900/50 rounded-xl border border-dashed border-gray-200 dark:border-zinc-800">
                            <div className="max-w-md mx-auto">
                                <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2 uppercase">No results found</h3>
                                <p className="text-gray-500 font-sans">We couldn't find any reports matching <span className="font-bold underline italic text-red-700 opacity-80">"{query}"</span>. Try different keywords or check your spelling.</p>
                            </div>
                        </div>
                    )}
